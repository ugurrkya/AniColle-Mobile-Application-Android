...
public class EditProfileActivity extends AppCompatActivity {
  ...
  //  private static final int REQUEST_CAMERA= 3;
        ...
        profileUserRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    nameofuser = (TextView) findViewById(R.id.usernamee);
                    nameofuser.setText(myUsername);
                    nameofuser.setVisibility(View.INVISIBLE);
                }
            }
    ...
    private void saveUserProfile() {
        ...
        if((downloadUrl.equals("20")) && resultUri==null ){

            Toast.makeText(this, "Please complete your profile", Toast.LENGTH_SHORT).show();
        }
        else if ((downloadUrl.equals("20")) && resultUri == null){
            ...
            String myname= nameofuser.getText().toString();
                        HashMap<String, String> profileMap = new HashMap<>();
                        profileMap.put("username",myname);
                                ...
                                RootRef.child("Users").child(currentUserID).child("imageurl").setValue(downloadUrl).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            final String dd;
                                            Toast.makeText(EditProfileActivity.this, "Saved in database", Toast.LENGTH_SHORT).show();
                                        } else {
